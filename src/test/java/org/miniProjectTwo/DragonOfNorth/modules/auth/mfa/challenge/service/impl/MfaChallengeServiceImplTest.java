...
import org.miniProjectTwo.DragonOfNorth.modules.auth.mfa.challenge.provider.ChallengeProviderVerification;
...
class MfaChallengeServiceImplTest {
    ...
    void verifyAndConsume_shouldRejectProviderNotBoundToChallenge() {
        ...
        ChallengeState state = new ChallengeState(UUID.randomUUID(), "pwd", "device-1", "203.0.113", new TokenHasher().sha256Hex("Mozilla/5.0"), List.of(ProviderType.TOTP), 0, null, null);
