 ...
 * PENDING_VERIFICATION requires OTP email verification before login is allowed,
 * ACTIVE enables full authentication, LOCKED blocks access due to policy,
 * DELETED blocks all access. Critical for security and user journey management.
 *
