...
public class RefreshTokenServiceImpl implements RefreshTokenService {
    ...
    public RefreshTokenServiceImpl(RefreshTokenRepository refreshTokenRepository, TokenHasher tokenHasher) {
    ...
    public void storeRefreshToken(AppUser user, String rawToken) {
        ...
        refreshToken.setTokenPrefix(rawToken.substring(0, 8));
