...
/**
 * Bootstrap payload for MFA setup.
 * <p>
 * The secret and QR code represent temporary enrollment material and should be handled as sensitive
 * data in logs and telemetry.
 */
