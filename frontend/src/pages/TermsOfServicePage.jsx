...
const TermsOfServicePage = () => (
    ...
    >
        <section className="docs-legal-card space-y-6 text-sm leading-7">
            <div>
                <h3 className="docs-legal-title text-xl font-semibold">1. Acceptance of Terms</h3>
            ...
            <div>
                <h3 className="docs-legal-title text-xl font-semibold">2. Eligibility and Account Registration</h3>
            ...
            <div>
                <h3 className="docs-legal-title text-xl font-semibold">3. Service Description</h3>
            ...
            <div>
                <h3 className="docs-legal-title text-xl font-semibold">4. Acceptable Use</h3>
            ...
            <div>
                <h3 className="docs-legal-title text-xl font-semibold">5. Security and Authentication</h3>
            ...
            <div>
                <h3 className="docs-legal-title text-xl font-semibold">6. Third-Party Services</h3>
            ...
            <div>
                <h3 className="docs-legal-title text-xl font-semibold">7. Fees and Commercial Terms</h3>
            ...
            <div>
                <h3 className="docs-legal-title text-xl font-semibold">8. Intellectual Property</h3>
            ...
            <div>
                <h3 className="docs-legal-title text-xl font-semibold">9. Service Availability and Changes</h3>
            ...
            <div>
                <h3 className="docs-legal-title text-xl font-semibold">10. Suspension and Termination</h3>
            ...
            <div>
                <h3 className="docs-legal-title text-xl font-semibold">11. Privacy</h3>
            ...
            <div>
                <h3 className="docs-legal-title text-xl font-semibold">12. Disclaimers</h3>
            ...
            <div>
                <h3 className="docs-legal-title text-xl font-semibold">13. Limitation of Liability</h3>
            ...
            <div>
                <h3 className="docs-legal-title text-xl font-semibold">14. Indemnification</h3>
            ...
            <div>
                <h3 className="docs-legal-title text-xl font-semibold">15. Governing Law and Dispute Resolution</h3>
            ...
            <div>
                <h3 className="docs-legal-title text-xl font-semibold">16. Changes to These Terms</h3>
            ...
            <div>
                <h3 className="docs-legal-title text-xl font-semibold">17. Contact Information</h3>
